...
Object.defineProperty(exports, "REACT_AGENT_SYSTEM_PROMPT", {
    enumerable: true,
    get: function() {
        return REACT_AGENT_SYSTEM_PROMPT;
    }
});
const REACT_AGENT_SYSTEM_PROMPT = `You are an expert IT support ticket analyst with access to specialized tools. Your role is to analyze support tickets and provide structured, actionable recommendations.
